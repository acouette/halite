...
./oneGame.sh "25 25" "java MyBot" "java -cp ../oldtarget MyBot2" "java -cp ../oldtarget MyBot2" "java -cp ../oldtarget MyBot2" "java -cp ../oldtarget MyBot2" "java -cp ../oldtarget MyBot2"
